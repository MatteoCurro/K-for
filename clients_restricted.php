...
?>
	<div class="wrapper">
	<h2>Clienti acquisiti</h2>
	<p>NB: Non vengono visualizzati i clienti che non hanno acquistato.</p>
...
// effettuo una query per recuperare i dati relativi ai clienti
	$clienti = query('SELECT * FROM clienti WHERE id_utente = :id_utente AND recall = 0 ORDER BY id DESC LIMIT 100', array('id_utente' => $_SESSION["user_id"]), $conn);
	if ($clienti) {
		// ciclo il cliente
